...
function HeroSec() {
  return (
    <header id='home' className='min-w-full bg-gray-100 min-h-[800px] md:min-h-screen flex flex-wrap-reverse justify-center md:justify-evenly  items-center ' >
      ...
      <div className='flex flex-col after:hidden justify-center items-center sm:mx-10 my-4 lg:mt-24'>
        ...
        <div className='flex flex-wrap gap-5 justify-center mt-4'>
          <a href="#hireme">
        <button className=' px-2 py-1 shrink-0 text-lg sm:px-4 sm:py-2 sm:text-xl font-medium text-white bg-indigo-500 hover:bg-indigo-700 hover:delay-75 hover:duration-300 rounded hover:font-medium'>Hire me</button></a>
        <a download href="/cv.pdf">
        <button  className='flex gap-x-2 items-center hover:scale-105 px-2 py-1 shrink-0 text-md sm:px-6  sm:py-2 sm:text-xl  sm:font-medium text-black border border-indigo-500 hover:delay-100 hover:duration-500 rounded hover:text-md'>Download CV<IoCloudDownload /></button>
        </a>
        </div>
